...
const ANALYSIS_PROMPT = `
 ...
 Your response should include only a JSON object with two properties, an "amounts" array and a "tasks" array, nothing else. Example:
 ...
 "tasks": [
 "Create and deliver one high-quality product image."
 ]
 }
